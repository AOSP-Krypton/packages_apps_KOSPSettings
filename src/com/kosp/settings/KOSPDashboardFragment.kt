...
import com.kosp.support.fragment.ColorPickerFragment
import com.kosp.support.preference.ColorPickerPreference

abstract class KOSPDashboardFragment : DashboardFragment() {

    override fun getMetricsCategory(): Int = MetricsProto.MetricsEvent.KOSP
