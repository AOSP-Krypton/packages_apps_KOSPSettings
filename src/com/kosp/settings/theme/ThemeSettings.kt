...
@SearchIndexable
class ThemeSettings : KOSPDashboardFragment() {
    ...
    companion object {
        ...
        private fun buildPreferenceControllers(
            ...
            val isAospLauncherInstalled = KOSPUtils.isPackageInstalled(
                context,
                TARGET_LAUNCHER,
                false /** ignoreState */,
            )
            val isAospThemePickerInstalled = KOSPUtils.isPackageInstalled(
                context,
                TARGET_THEME_PICKER,
                false /** ignoreState */,
            )
